...
aulas/                 → uma página HTML por aula
...
3. Abra `index.html` e adicione um novo `<li>` dentro de `<ul class="aula-list">`, copiando o bloco de um cartão existente e ajustando data, módulo, título e o link `href="aulas/seu-novo-arquivo.html"`.
4. Salve, publique (veja abaixo) e confira o site no ar.
